...
public class PcSubmission extends Submission {
    ...
    public PcSubmission(
            UUID id, SubmissionMetadata metadata, Location location,
            String respondentName, String respondentPhone, String respondentGender, AgeGroup respondentAgeGroup,
            Long amountExpected, Long amountReceived, Integer totalBeneficiaries, Integer youthBeneficiaries,
            Integer youngWomenBeneficiaries, Integer youngMenBeneficiaries, NarrativeText obstaclesDescription,
            Boolean spendingTargetedToMostInNeed, Integer pdcTotalMembers, Integer pdcYouthMembers,
            Integer pdcWomenMembers, Boolean pdcTrainingReceived, List<String> pdcTrainingAreas,
            PdcEffectivenessRating pdcEffectivenessRating, Boolean programmeMonitored, List<String> monitoredBy,
            String monitoredByOthersSpecify, NarrativeText monitoringMethod, Boolean reportSharedWithRespondent,
            Boolean improvementsSeen, NarrativeText improvementsSeenExplanation, Boolean progressReportsSubmitted,
            NarrativeText progressReportsSubmittedExplanation, Integer selfRelianceBeneficiariesCount,
            Integer selfRelianceStableIncomeCount, Integer selfRelianceTrainedCount,
            Integer selfRelianceGroupProjectsCount, NarrativeText programmeImprovementSuggestion
    ) {
        ...
        if (obstaclesDescription == null) throw new IllegalArgumentException("Obstacles description is required");
        if (spendingTargetedToMostInNeed == null) throw new IllegalArgumentException("Spending targeted indicator is required");
        if (pdcTotalMembers == null || pdcTotalMembers < 0 || pdcYouthMembers == null || pdcYouthMembers < 0 || pdcWomenMembers == null || pdcWomenMembers < 0) {
            throw new IllegalArgumentException("PDC members counts must be positive");
        }
        if (pdcTrainingReceived == null) throw new IllegalArgumentException("PDC training received indicator is required");
        if (pdcEffectivenessRating == null) throw new IllegalArgumentException("PDC effectiveness rating is required");
        if (programmeMonitored == null) throw new IllegalArgumentException("Programme monitored indicator is required");
        if (monitoredBy == null || (Boolean.TRUE.equals(programmeMonitored) && monitoredBy.isEmpty())) {
            throw new IllegalArgumentException("Monitored by list cannot be empty when programme is monitored");
        }
        if (monitoringMethod == null) throw new IllegalArgumentException("Monitoring method is required");
        if (reportSharedWithRespondent == null) throw new IllegalArgumentException("Report shared indicator is required");
        if (improvementsSeen == null) throw new IllegalArgumentException("Improvements seen indicator is required");
        if (progressReportsSubmitted == null) throw new IllegalArgumentException("Progress reports indicator is required");
        if (selfRelianceBeneficiariesCount == null || selfRelianceBeneficiariesCount < 0
                || selfRelianceStableIncomeCount == null || selfRelianceStableIncomeCount < 0
                || selfRelianceTrainedCount == null || selfRelianceTrainedCount < 0
        ...
        if (programmeImprovementSuggestion == null) throw new IllegalArgumentException("Programme improvement suggestion is required");
    ...
    public NarrativeText getObstaclesDescription() { return obstaclesDescription; }
    ...
    public NarrativeText getMonitoringMethod() { return monitoringMethod; }
    ...
    public NarrativeText getImprovementsSeenExplanation() { return improvementsSeenExplanation; }
    public Boolean getProgressReportsSubmitted() { return progressReportsSubmitted; }
    public NarrativeText getProgressReportsSubmittedExplanation() { return progressReportsSubmittedExplanation; }
    ...
    public NarrativeText getProgrammeImprovementSuggestion() { return programmeImprovementSuggestion; }

    @Override
    public FormType getFormType() { return FormType.PC; }

    @Override
    public void validate() {
        if (youthBeneficiaries > 0) {
            if (youngMenBeneficiaries == null || youngMenBeneficiaries < 0) {
                throw new IllegalArgumentException("Young men beneficiaries count is required when youth beneficiaries is greater than zero");
            }
            if (youngWomenBeneficiaries + youngMenBeneficiaries > youthBeneficiaries) {
                throw new IllegalArgumentException("Young women and young men beneficiaries cannot exceed youth beneficiaries");
            }
        }
        ...
        if (Boolean.TRUE.equals(programmeMonitored) && monitoredBy.isEmpty()) {
            throw new IllegalArgumentException("Monitored by list cannot be empty when programmeMonitored is true");
        }
        if (monitoredBy.contains("OTHERS") && (monitoredByOthersSpecify == null || monitoredByOthersSpecify.trim().isEmpty())) {
