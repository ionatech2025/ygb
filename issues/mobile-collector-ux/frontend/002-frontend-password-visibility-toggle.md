...
- [x] Component test: password hidden by default; toggle reveals plain text; second toggle hides again.
- [x] Component test: toggle button has accessible label and is keyboard operable.
- [x] `PortalLogin` test: login flow unchanged (still submits password value).
- [x] `ManageUsers` test: register-collector password field renders toggle.
