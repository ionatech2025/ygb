...
- [ ] **Domain test** (`PhoneNumberTest`): accept each prefix — `077`, `078`, `076`, `039`, `075`, `070`, `074`, `072`, `071`, `079` — with a valid 10-digit local number.
- [ ] **Domain test:** international `+25674…` normalizes to `074…`.
- [ ] **Domain test:** reject too short, too long, wrong country, or invalid prefix (e.g. `067…`).
- [ ] **Adapter test:** submission / user-registration endpoints accept `074…` respondent or collector phone without 400.
- [ ] Update error message to reference general format, not only `0772…` examples.
