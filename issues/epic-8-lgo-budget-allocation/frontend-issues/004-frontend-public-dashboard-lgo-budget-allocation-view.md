...
- [ ] Component test: page renders filter panel, summary, and charts region (TC-LGOB-02-01).
- [ ] Component test: changing district filter refetches summary (mock adapter call count).
- [ ] Component test: empty dataset shows empty state, not error.
- [ ] Route test: unauthenticated access to LGO dashboard section.
