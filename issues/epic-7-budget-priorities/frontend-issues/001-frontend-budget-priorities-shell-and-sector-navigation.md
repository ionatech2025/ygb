...
- [ ] Component test: index page renders four sector cards with correct labels.
- [ ] Route test: unauthenticated visitor loads `/budget-priorities` — no redirect to login.
- [ ] Route test: `/budget-priorities/health` loads section layout shell.
- [ ] Component test: public nav includes Budget Priorities link.
- [ ] Component test: invalid section slug → friendly 404 or redirect to index.
- [ ] Implement routes, index page, section layout shell, nav link.
