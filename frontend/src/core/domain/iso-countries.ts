...
/** ISO 3166-1 alpha-2 countries for the download profile country picker. */
export const ISO_COUNTRY_OPTIONS: readonly IsoCountryOption[] = [
  ...
  { value: "OM", label: "Oman" },
  { value: "QO", label: "Outlying Oceania" },
...
export function filterIsoCountries(query: string): IsoCountryOption[] {
  const q = query.trim().toLowerCase();
  if (!q) {
    return [...ISO_COUNTRY_OPTIONS];
  }
  return ISO_COUNTRY_OPTIONS.filter(
    (option) =>
