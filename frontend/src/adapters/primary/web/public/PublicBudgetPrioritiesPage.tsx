...
export function PublicBudgetPrioritiesPage() {
  ...
  return (
    <div className={budgetPrioritiesClasses.dashboardPage} data-testid="public-budget-priorities-dashboard">
      <header className={budgetPrioritiesClasses.dashboardHero} data-testid="bp-dashboard-hero">
        ...
        <div
          className={`${budgetPrioritiesClasses.heroContent} flex flex-col gap-6 xl:flex-row xl:items-start xl:justify-between`}
        >
          <div className="min-w-0 flex-1">
            <p className={budgetPrioritiesClasses.heroEyebrow}>Public dashboard</p>
            ...
            <div className={budgetPrioritiesClasses.heroBadges}>
              <span className={budgetPrioritiesClasses.heroBadge}>
      ...
      <section data-testid="bp-dashboard-filters-section" className={budgetPrioritiesClasses.dashboardSection}>
        <h2 className={budgetPrioritiesClasses.sectionHeading}>
          <BarChart3 className={budgetPrioritiesClasses.sectionHeadingIcon} aria-hidden="true" />
          Explore data
        </h2>
        <BudgetPriorityDashboardFilterPanel dashboardApi={dashboardApi} />
      </section>

      <section data-testid="bp-dashboard-summary-section" className={budgetPrioritiesClasses.dashboardSection}>
        <h2 className={budgetPrioritiesClasses.sectionHeading}>
          <BarChart3 className={budgetPrioritiesClasses.sectionHeadingIcon} aria-hidden="true" />
          Summary statistics
        </h2>
