...
| **PUB-03** | Interactive filters: District, Sub-county, Parish, Age Group, Gender, Form Type (BYP/IYP/LGO/PC), Financial Year Period (Jan–Jun / Jul–Dec), Date Range, and Programme Area. Filters update all charts and statistics in real time. | Must Have | |
